...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const description = `Juega a los mejores juegos de ${cat.name} HTML5 online gratis. Sin descargas ni registros.`;
        ...
        <div className="mt-12 p-6 bg-surface rounded-xl border border-border/50">
          ...
          <p className="text-muted text-sm leading-relaxed">
            {category.description ||
              `Descubre la mejor colección de juegos de ${category.name} HTML5 online. Juega gratis desde tu navegador sin instalar nada.`}
          </p>
        </div>
      </div>
    </>
